...
This Python version uses the **real tokagentOS Python runtime**:

- All environment updates are sent as Tokagent `Memory` objects
...
it goes through Tokagent’s canonical message service.
