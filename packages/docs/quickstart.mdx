---
title: "Quickstart"
description: "Create and run your first tokagentOS agent in 3 minutes"
---
  ...
  <Tab title="TypeScript">
    <Steps>
      <Step title="Create Your Project">
        Create a new tokagentOS project using the interactive CLI:
        ...
        <Note>
          The CLI is for building agents and projects. The monorepo is only for contributing to tokagentOS core. See [CLI vs Monorepo](https://www.youtube.com/watch?v=tSO4wpQs2OA&list=PLrjBjP4nU8ehOgKAa0-XddHzE0KK0nNvS).
        </Note>
      </Step>
      ...
      <Step title="Chat with Your Agent">
        ...
        Start chatting with Tokagent through the web interface!
      </Step>
    </Steps>
  ...
  <Tab title="Python">
    <Steps>
      <Step title="Set Up Your Environment">
        ...
        ```bash
        mkdir my-tokagent-agent
        cd my-tokagent-agent
        python -m venv .venv
      ...
      <Step title="Create Your Agent">
        ...
        ```python
        import asyncio
        from tokagentos import AgentRuntime, Character, Memory, Content, ChannelType
  ...
  <Tab title="Rust">
    <Steps>
      ...
      <Step title="Add Dependencies">
        ...
        ```toml
        [package]
        name = "my-tokagent-agent"
        version = "0.1.0"
        edition = "2021"

        [dependencies]
        tokagentos = "1.0"
        tokagentos-plugin-openai = "1.0"
...
<AccordionGroup>
  ...
  <Accordion icon="database" title="Database Issues">
    **TypeScript (PGLite):**
    ```
    PGLITE_DATA_DIR=/path/to/your/project/.tokagent/.tokagentdb
    ```
  ...
  <Accordion icon="wrench" title="Common Fixes">
    ...
    **TypeScript - Start fresh:**
    ```bash
    rm -rf my-tokagent-project
    tokagentos create
    ```

    **Python - Reinstall:**
    ```bash
    pip uninstall tokagentos tokagentos-plugin-openai
    pip install tokagentos tokagentos-plugin-openai
    ```
