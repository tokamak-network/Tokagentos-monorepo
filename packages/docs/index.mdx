...
<Card
  title="$tokagentOS Token Information"
  icon="coins"
  href="/tokenomics"
  color="#0B35F1"
>
...
tokagentOS is available in **TypeScript**, **Python**, and **Rust** with identical APIs. Choose your preferred language and get started in minutes.

<CardGroup cols={3}>
  <Card title="TypeScript" icon="js" href="/quickstart#typescript">
    The original tokagentOS experience. Full Node.js ecosystem.
  </Card>
...
<Tabs>
  <Tab title="TypeScript">
    ```bash bun i -g tokagentos # Install the CLI tokagentos create # Create your
    project tokagentos start # Your agent is live ```
  </Tab>
  <Tab title="Python">
    ```bash pip install tokagentos # Install the package python -c "from tokagentos
    import *" # Verify installation python your_agent.py # Run your agent ```
  </Tab>
  <Tab title="Rust">
    ```bash cargo add tokagentos # Add to Cargo.toml cargo build # Build your
