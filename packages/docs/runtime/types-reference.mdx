...
description: "Complete TypeScript types and interfaces reference for tokagentOS"
---

## Overview

This page documents the core TypeScript types and interfaces used throughout tokagentOS. For usage examples, see the relevant feature documentation.

<Tip>
All types are exported from `@tokagentos/core`. Import what you need:
```typescript
import { Memory, Action, State, UUID } from '@tokagentos/core';
```
</Tip>
