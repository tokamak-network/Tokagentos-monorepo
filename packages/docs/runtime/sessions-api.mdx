...
function useTokagentSession(agentId, userId) {
...
The Sessions API provides a comprehensive set of endpoints for managing stateful conversations with TokagentOS agents. This reference covers all available endpoints, request/response schemas, and error handling.
...
<CardGroup cols={2}>
  ...
  >
    Understand TokagentOS runtime architecture
  </Card>
