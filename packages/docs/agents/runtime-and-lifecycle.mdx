...
description: "From Character configuration to live Agent execution in tokagentOS"
---
...
```typescript
import { validateCharacter } from "@tokagentos/core";
...
import { PostgresDatabaseAdapter } from "@tokagentos/plugin-sql";
import { character } from "./character";
