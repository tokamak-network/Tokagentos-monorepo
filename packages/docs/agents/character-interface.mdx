...
export const character: Character = {
  ...
  plugins: ["@tokagentos/plugin-openai"],
};
```
  </Tab>
  <Tab title="Python">
...
````
  ...
  <Tab title="Rust">
```rust
use tokagentos::parse_character;
...
In tokagentOS, the distinction between a **Character** and an **Agent** is fundamental:
...
````
  ...
  <Tab title="Rust">
```rust
use tokagentos::{AgentRuntime, RuntimeOptions};
