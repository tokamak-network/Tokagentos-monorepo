...
Build interactive chat agents that run in your terminal. These examples demonstrate core tokagentOS functionality: agent initialization, message handling, streaming responses, and conversation flow.

## Overview

The chat example is the simplest way to understand tokagentOS. It creates an agent, sends messages, and displays responses in real-time.
