---
title: "Game Examples"
description: "Build AI-powered games with tokagentOS in TypeScript, Python, and Rust"
---
...
- **Game Loop Integration**: Real-time interaction with the tokagentOS runtime
