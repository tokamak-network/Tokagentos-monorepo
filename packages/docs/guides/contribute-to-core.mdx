...
description: "How to contribute to the tokagentOS core project and plugin ecosystem"
---

<Note>
  This guide covers contributing to the main tokagentOS monorepo and the tokagentOS
  plugin ecosystem.
</Note>

## Understanding the Ecosystem

tokagentOS open source contribution happens across these main areas:

### Main Repository (Monorepo)

**[github.com/tokagentos/tokagent](https://github.com/tokagentos/tokagent)** - The core monorepo containing:

- `packages/typescript` - Runtime, types, interfaces, and basic-capabilities plugin
- `packages/cli` - Command-line tools and tokagentos CLI
...
**[github.com/tokagentos-plugins](https://github.com/tokagentos-plugins)** - Official plugins maintained by the tokagentOS team:
...
**[tokagentos/tokagent/issues](https://github.com/tokagentos/tokagent/issues)**
...
### tokagentOS-Maintained Plugin Issues

Find issues in tokagentOS-maintained plugins (often more focused for first contributions):

**Official tokagentOS plugins:**

- [plugin-x/issues](https://github.com/tokagentos-plugins/plugin-x/issues)
- [plugin-discord/issues](https://github.com/tokagentos-plugins/plugin-discord/issues)
- [plugin-evm/issues](https://github.com/tokagentos-plugins/plugin-evm/issues)
...
3. **Create a detailed issue** with:
   ...
   - Environment details (OS, Node/Bun version, tokagentOS version)
...
- Add tutorials to the tutorials section in [docs repository](https://github.com/tokagentos/docs)
- Update any outdated references, instructions, or broken links you find
- Fix typos, improve clarity, or add missing examples

**Community support:**

- **Answer questions** in [GitHub Discussions](https://github.com/orgs/tokagentOS/discussions) Q&A section
- **Help with troubleshooting** - Setup issues, configuration problems, etc.
- **Share knowledge** in general discussions about tokagentOS development
...
<Tip>
  ...
  often the most impactful ways to help other developers succeed with tokagentOS.
</Tip>
...
tokagentOS follows standard open source contribution practices for all repositories.
...
- **Main repository (tokagentos/tokagent):** Target `develop` branch
...
**[Join tokagentOS Discord](https://discord.gg/ai16z)**
