...
<Card
  title="Get Started with Tokagent Cloud"
  icon="rocket"
...
Need more control? Here's how Tokagent Cloud compares:

|                        | Tokagent Cloud | Railway/Render | Self-Hosted |
| ---------------------- | :---------: | :------------: | :---------: |
...
| **tokagentOS optimized**  |     ✅      |       ❌       |     ❌      |

<Note>
  **For Advanced Users:** If you're experienced with server administration and
  networking, you can deploy tokagentOS like any Node.js application using your
...
<Steps>
  <Step title="Create your project">
    ```bash Terminal
    tokagentos create my-agent --type project
    cd my-agent
    ```
  </Step>
...
<Step title="Add environment variables">
  ...
  TOKAGENT_UI_ENABLE=true # If using Postgres (can add PostgreSQL service in
...
Phala offers secure deployment with excellent tokagentOS integration and a good CLI. Perfect for production agents requiring a good mix of cost-effective and good security.
...
<Step title="Configure environment variables">
  ...
  POSTGRES_URL=postgresql://user:password@host:5432/tokagent # If your project has
  a frontend/web UI TOKAGENT_UI_ENABLE=true # Everything else in your .env
...
<CardGroup cols={2}>
  ...
  <Card title="Publish a Plugin" icon="upload" href="/guides/publish-a-plugin">
    Share your custom plugins with the tokagentOS community
  </Card>
</CardGroup>
