...
// NEW (1.x)
import { Action, Memory, State, ActionResult } from "@tokagentos/core";
```
...
```typescript
import { composePromptFromState } from "@tokagentos/core";
...
- [ ] All imports updated to `@tokagentos/core`
