...
The basic-capabilities plugin is built into `@tokagentos/core` and automatically registered during runtime initialization. It provides core functionality through:
