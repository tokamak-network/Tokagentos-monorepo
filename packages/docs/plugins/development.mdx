...
- ✅ Integration with `@tokagentos/core`
...
const externalDeps = ["@tokagentos/core"];
...
**Solution**: Ensure `@tokagentos/core` is installed and TypeScript is configured correctly.
