...
description: "Browse all tokagentOS examples by category, platform, and language"
---
...
<CardGroup cols={2}>
  <Card title="CLI Chat" icon="terminal" href="/examples/chat">
    The simplest way to understand tokagentOS. Build an interactive chat agent in
    50 lines of code.
  </Card>
  <Card title="HTML TOKAGENT" icon="code" href="/examples/browser#html-example">
