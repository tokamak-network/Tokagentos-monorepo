...
description: "HTTP endpoints for tokagentOS using 8 different web frameworks"
---

Build REST APIs for your tokagentOS agents using your preferred framework.
...
from tokagentos.plugin_tokagent_classic import tokagent_classic_plugin

app = FastAPI()

runtime = AgentRuntime(
    character=Character(name="Tokagent", bio="A helpful AI."),
    plugins=[tokagent_classic_plugin],
)
...
use tokagentos_plugin_tokagent_classic::create_tokagent_classic_plugin;
...
async fn main() -> std::io::Result<()> {
    ...
    let runtime = AgentRuntime::new(RuntimeOptions {
        ...
        plugins: vec![create_tokagent_classic_plugin()],
        ..Default::default()
    }).await?;
