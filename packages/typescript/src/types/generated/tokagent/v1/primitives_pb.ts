// primitives.proto - Core primitive types for tokagentOS
// Single source of truth for TypeScript, Python, and Rust

// @generated by protoc-gen-es v2.2.2 with parameter "target=ts,import_extension=.js"
// @generated from file tokagent/v1/primitives.proto (package tokagent.v1, syntax proto3)
/* eslint-disable */
 ...
 */
export const file_tokagent_v1_primitives: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_struct]);
...
export const UUIDSchema: GenMessage<UUID> = /*@__PURE__*/
  messageDesc(file_tokagent_v1_primitives, 0);
 ...
 */
export const DefaultUUIDSchema: GenMessage<DefaultUUID> = /*@__PURE__*/
  messageDesc(file_tokagent_v1_primitives, 1);
...
export const MediaSchema: GenMessage<Media> = /*@__PURE__*/
  messageDesc(file_tokagent_v1_primitives, 2);
 ...
 */
export const MentionContextSchema: GenMessage<MentionContext> = /*@__PURE__*/
  messageDesc(file_tokagent_v1_primitives, 3);
...
export const ContentSchema: GenMessage<Content> = /*@__PURE__*/
  messageDesc(file_tokagent_v1_primitives, 4);
...
export const MetadataSchema: GenMessage<Metadata> = /*@__PURE__*/
  messageDesc(file_tokagent_v1_primitives, 5);
