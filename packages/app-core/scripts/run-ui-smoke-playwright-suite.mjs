...
env.TOKAGENT_UI_SMOKE_API_PORT =
  env.TOKAGENT_UI_SMOKE_API_PORT || env.MILADY_UI_SMOKE_API_PORT;
env.MILADY_API_PORT = env.MILADY_API_PORT || env.MILADY_UI_SMOKE_API_PORT;
env.TOKAGENT_API_PORT = env.TOKAGENT_API_PORT || env.MILADY_UI_SMOKE_API_PORT;

if (!env.MILADY_UI_SMOKE_PORT) {
  const uiPort = await getFreePort();
  env.MILADY_UI_SMOKE_PORT = String(uiPort);
}
env.TOKAGENT_UI_SMOKE_PORT = env.TOKAGENT_UI_SMOKE_PORT || env.MILADY_UI_SMOKE_PORT;
env.MILADY_PORT = env.MILADY_PORT || env.MILADY_UI_SMOKE_PORT;
env.TOKAGENT_PORT = env.TOKAGENT_PORT || env.MILADY_UI_SMOKE_PORT;
