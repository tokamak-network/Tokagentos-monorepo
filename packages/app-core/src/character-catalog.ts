...
export const TOKAGENT_CHARACTER_ASSET_COUNT = 0;

export const DEFAULT_TOKAGENT_CHARACTER_ASSET: ResolvedCharacterAsset | null =
  null;
...
export const TOKAGENT_INJECTED_CHARACTER_COUNT = 0;
