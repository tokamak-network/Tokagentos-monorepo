...
// Tokagent overlay: music-library + music-player chat widgets removed.
...
// Tokagent overlay: music-player + music-library widgets removed.
...
export const BUILTIN_WIDGET_DECLARATIONS: PluginWidgetDeclaration[] = [
  ...
  // Tokagent overlay: music-player chat widget + music-library character
  // widget removed.
];
...
// Tokagent overlay: music-player removed from always-visible set.
const ALWAYS_VISIBLE_BUILTIN_WIDGET_PLUGIN_IDS = new Set<string>();
