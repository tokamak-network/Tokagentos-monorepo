        ...
        {!elizaCloudConnected ? (
          <div className="text-muted">
            {t("settings.instanceRoutingNotConnected", {
              defaultValue:
                "Connect to cloud above to enable instance routing. This lets messages from any platform reach your local instance through the cloud gateway.",
            })}
          </div>
        ) : isActive ? (
          <div className="space-y-1">
            <div className="text-accent">
              {t("settings.instanceRoutingActive", {
                defaultValue:
                  "This instance is registered and receiving messages via cloud gateway relay.",
              })}
            </div>
