        ...
        >
            ...
            >
              <title>
                {t("configpageview.CloudModeSvgTitle", {
                  defaultValue: "Cloud managed RPC",
                })}
              </title>
          ...
          <span className="text-xs-tight text-muted leading-snug">
            {t("configpageview.CloudModeDesc", {
              defaultValue:
                "Managed RPC for EVM, BSC, and Solana via cloud, with Helius on Solana.",
            })}
          </span>
          {rpcMode === "cloud" && (
                ...
                <span className="text-sm font-semibold text-txt">
                  {elizaCloudAuthRejected
                    ? t("configpageview.ElizaCloudKeyInvalid", {
                        defaultValue: "Cloud key invalid",
                      })
                    : t("configpageview.ConnectedToElizaCloud", {
                        defaultValue: "Connected to Cloud",
                      })}
                </span>
              ...
              >
                <title>
                  {t("configpageview.CloudLoginRequiredSvgTitle", {
                    defaultValue: "Cloud login required",
                  })}
                </title>
                <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" />
              </svg>
