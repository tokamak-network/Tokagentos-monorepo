      ...
      throw new Error(
        provisionResponse.error ||
          t("pluginsview.ManagedDiscordGatewayProvisionFailed", {
            defaultValue:
              "Failed to start the shared Discord gateway.",
          }),
      );
    }
    ...
    if (!elizaCloudConnected) {
      ...
      setActionNotice(
        t("pluginsview.ManagedDiscordRequiresCloud", {
          defaultValue:
            "Connect cloud first, then you can use managed Discord OAuth.",
        }),
        "info",
        5000,
      );
          ...
          >
            {elizaCloudConnected
              ...
              : t("pluginsview.ManagedDiscordGatewayHint", {
                  defaultValue:
                    "Prefer OAuth? Connect cloud to use the shared Discord gateway instead of a local bot token.",
                })}
