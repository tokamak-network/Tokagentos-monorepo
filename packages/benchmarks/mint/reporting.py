...
## TokagentOS Python Runtime Evaluation
...
**TokagentOS Overall Score**: {our_overall:.1%}

| Model | Published Score | vs TokagentOS |
|-------|----------------|------------|
{rows_str}
...
*Generated by TokagentOS MINT Benchmark Runner*
