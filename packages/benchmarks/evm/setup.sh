...
echo ""
echo "  # Full TokagentOS agent (recommended):"
echo "  USE_EXTERNAL_NODE=true MAX_MESSAGES=20 \\"
echo "    python -m benchmarks.evm.tokagent_agent"
echo ""
echo "  # Standalone explorer (no TokagentOS, uses LangChain):"
echo "  USE_EXTERNAL_NODE=true python -m benchmarks.evm.tokagent_explorer"
echo ""
